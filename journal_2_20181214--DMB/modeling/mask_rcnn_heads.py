...
def mask_rcnn_fcn_head_denseblock_4convs_1op(
    ...
    current = model.net.Sum(
        ['_[mask]_global_scaled', ROI_Input],
        '_[mask]_global_out'
    )
...
# Man! this input is big AF!, try to optimize it
    ...
    fcn_global_out = model.net.Sum(
        ['_[mask]_fcn_global_scaled', convfcn5],
    ...
    blob_mask = model.Relu('conv5_mask_fcn', 'conv5_mask_fcn')
