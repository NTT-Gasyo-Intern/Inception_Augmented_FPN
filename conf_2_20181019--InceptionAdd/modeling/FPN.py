...
###### TODO: !PLEASE OPTIMIZE THE DESIGN! ######
...
## Inception lateral - using topdown
    ...
    inception_output_expanded = model.Conv(
        'inception_out',
    ...
    bottom_seed = model.net.Sum(
        ['inception_out_expanded', lateral_input_blobs_dim_shrunk[num_backbone_stages - 1]],
        'bottom_seed_bpa'
        )
...
def add_bottomup_lateral_module(
    model, fpn_bottom, fpn_lateral, fpn_top, fpn_dim
):
