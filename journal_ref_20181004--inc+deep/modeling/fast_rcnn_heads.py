...
def add_roi_2mlp_head(model, blob_in, dim_in, spatial_scale):
    ...
    logger.info('Creating Fast RCNN Branch...')
    logger.info('Implements 2 FC layers')
...
def add_roi_3mlp_head(model, blob_in, dim_in, spatial_scale):
    """Add a ReLU MLP with two hidden layers."""
    logger = logging.getLogger(__name__)
    logger.info('Creating Fast RCNN Branch...')
    logger.info('Implements 2 FC layers')
    ...
    model.FC('fc6', 'fc7', hidden_dim, hidden_dim)
    model.Relu('fc7', 'fc7')
    model.FC('fc7', 'fc8', hidden_dim, hidden_dim)
    model.Relu('fc8', 'fc8')
    return 'fc8', hidden_dim
